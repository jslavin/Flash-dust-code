...
!! DESCRIPTION
!!
!!  Release pointer (or pointers) to data of variable(s) described by a variable desciptor.
!!
!! ARGUMENTS
!!
...
!!
!!   dataptr2 : data pointer two; used for face-centered variables in second direction
!!
!!   dataptr3 : data pointer three; used for face-centered variables in third direction
!!
!! SEE ALSO
!!
!!  Grid_genGetBlkPtr
