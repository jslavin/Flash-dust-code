...
!-------Pointer to parent
!!$        Type(ptr_to_node) :: parent   ! was unused - KW
!-------Level in the tree.
        Integer :: level
...
!!$        Logical :: searched   ! was unused - KW
      End Type node
...
!-----Input/Output Arguments
      Type(node), Pointer :: t
      Type(node), POINTER_INTENT_IN :: tpar
      Type(node), POINTER_INTENT_IN :: top
...
!-----Input/Output Arguments
      Type(node), POINTER_INTENT_IN :: loc_t
...
!! RETURNS
!!
!!   A zero'ed-out tree is returned
!!
!! DESCRIPTION
!!
