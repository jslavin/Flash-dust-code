  ...
  subroutine internal_getBlkHandle(blockID, pe, accessBlkOut)
    ...
    subroutine prioselector(bcTypeToApply,directionToApply,leftOrRight,bcTypeFromParamesh)
      ...
      case(1)
         ...
         bcTypeToApply = bbbc(directionToApply,lowOrHigh,dirSet,surrblks)
      case(2)
#define NODIR 0
...
!            print*,'case 2B',dirSetToOrder,directionToApply
            ...
            bcTypeToApply = bbbc(directionToApply,lowOrHigh,dirSetToOrder,surrblks)
         end if
!!#if NDIM > 2
      case(3)
...
!!#endif
    ...
    integer function bbbc(directionToApply,lowOrHigh,dirset,surrblks)
