!!****if* source/physics/sourceTerms/Cool/CoolMain/CloudyJDS/Cool_computeDt
!!
!! NAME
!!  
!!  Cool_computeDt
...
!!  Version for Cloudy cooling function calculated by Jonathan D. Slavin
!!
!!
!! ARGUMENTS
!!
...
subroutine Cool_computeDt (blockID, &
  ...
  use Cool_data, ONLY : useCool,cl_rho, cl_gamma, cl_meshMe, cl_dtmin, cl_m
#include "Flash.h"
#include "constants.h"
  ...
  real    :: dedt, eid, dt_temp, tcool, dens
