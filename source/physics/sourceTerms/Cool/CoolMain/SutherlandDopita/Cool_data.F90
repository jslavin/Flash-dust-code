...
! Data tables containing cooling curve(s)
  ...
  real, dimension(cl_Nmax), save :: cl_logT, cl_ne, cl_logGam, &
       cl_nt, cl_logLnet, cl_logLnorm, cl_logU, cl_logtau, cl_P12, &
       cl_rho24, cl_Ci, cl_mubar, cl_dlogGdlogU, cl_dlogLdlogU, &
       cl_dnedlogU, cl_dntdlogU
  integer, save               :: cl_N
...
! Parameter passing for ODE integrator
  ...
  real, save :: cl_rho, cl_gamma, cl_smalle, cl_Boltzmann, cl_AMU, cl_dtmin, &
      cl_smallt
